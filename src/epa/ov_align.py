...
def associate_est_gt(
    ...
    """Associate locally slower poses through safe interpolation, or legacy nearest pairs."""
    if interpolate_short_gaps:
        from epa.core.adaptive_association import associate_adaptive
        return associate_adaptive(t_est, p_est, q_est, t_gt, p_gt, q_gt, offset=offset)
