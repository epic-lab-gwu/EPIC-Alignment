...
def _send_blueprint(timeline_name: str):
        ...
        for label in labels:
            ...
            views.append(
                rrb.TimeSeriesView(
                    ...
                    contents=[f"/epa/time_series/{label}/**"],
    ...
    def _make_speed_view() -> object:
        return rrb.TimeSeriesView(
            ...
            time_ranges=history_range,
            plot_legend=rrb.Corner2D.RightTop,
            contents=["/epa/time_series/speed/**"],
            axis_x=rrb.TimeAxis(link="LinkToGlobal"),
        )
                                ...
                                contents=[
                                    rrb.Spatial3DView(
                                        ...
                                        eye_controls=rrb.EyeControls3D(
                                            tracking_entity="/epa/replay/gt/pose",
                                        ),
                                    ),
                                    rrb.Spatial3DView(
                                        name="Follow Step3",
                                        ...
                                        eye_controls=rrb.EyeControls3D(
                                            tracking_entity="/epa/replay/step3/pose",
                                        ),
                                    ),
                                ],
                                grid_columns=2,
...
def log_alignment_to_rerun(
    *,
    ...
    try:
        ...
        _send_timed_transforms(
            rr,
            entity_path="epa/replay/raw/pose",
        ...
        _send_timed_transforms(
            rr,
            entity_path="epa/replay/step3/pose",
        ...
        _send_timed_transforms(
            rr,
            entity_path="epa/replay/step2/pose",
        ...
        _send_timed_line_strips(
            rr,
            entity_path="epa/replay/gt/lines",
            positions=gt_replay,
            timeline_name=timeline_name,
            timeline_values=t_replay,
            radii=0.0011,
        ...
        _send_timed_line_strips(
            rr,
            entity_path="epa/replay/raw/lines",
            positions=raw_replay,
            timeline_name=timeline_name,
            timeline_values=t_replay,
            radii=0.0010,
        ...
        _send_timed_line_strips(
            rr,
            entity_path="epa/replay/step2/lines",
            positions=step2_replay,
            timeline_name=timeline_name,
            timeline_values=t_replay,
            radii=0.0010,
        ...
        _send_timed_line_strips(
            rr,
            entity_path="epa/replay/step3/lines",
            positions=step3_replay,
            timeline_name=timeline_name,
            timeline_values=t_replay,
            radii=0.0017,
        ...
        if raw_error_m is not None:
            _send_scalar_series(
                rr,
                entity_path="epa/error/scalars/raw_ate_m",
        ...
        if step2_error_m is not None:
            _send_scalar_series(
                rr,
                entity_path="epa/error/scalars/step2_ate_m",
        ...
        if step3_error_m is not None:
            _send_scalar_series(
                rr,
                entity_path="epa/error/scalars/step3_ate_m",
        ...
        _log_static_traj_label(
            rr,
            entity_path="epa/replay/gt/label",
            position_xyz=gt[-1],
            text="gt",
        )
        _log_static_traj_label(
            rr,
            entity_path="epa/replay/raw/label",
            position_xyz=raw[-1],
            text="raw",
        )
        _log_static_traj_label(
            rr,
            entity_path="epa/replay/step2/label",
            position_xyz=step2[-1],
            text="step2",
        )
        _log_static_traj_label(
            rr,
            entity_path="epa/replay/step3/label",
        ...
        if stage_stats:
            _send_statistics_bars(rr, "epa/error/statistics", stage_stats)
    ...
    *,
    ...
    try:
        ...
        for i, item in enumerate(trajectories):
            ...
            _send_timed_line_strips(
                rr,
                entity_path=f"epa/replay/{name}/lines",
                positions=pos,
                timeline_name=timeline_name,
                timeline_values=t,
                radii=0.0014,
            ...
            _send_timed_transforms(
                rr,
                entity_path=f"epa/replay/{name}/pose",
                positions=pos,
                quats_xyzw=quat,
                timeline_name=timeline_name,
                timeline_values=t,
            ...
            _log_static_traj_label(
                rr,
                entity_path=f"epa/replay/{name}/label",
                position_xyz=pos[-1],
                text=name,
            )
            logged += 1
...
def log_metric_to_rerun(
    *,
    ...
    try:
        ...
        _send_timed_line_strips(
            rr,
            entity_path="epa/replay/ref/lines",
            positions=ref_pos,
            timeline_name=timeline_name,
        ...
        _send_timed_line_strips(
            rr,
            entity_path="epa/replay/est/lines",
            positions=est_sel,
            timeline_name=timeline_name,
            timeline_values=t,
            radii=0.0016,
        ...
        _send_timed_transforms(
            rr,
            entity_path="epa/replay/ref/pose",
            positions=ref_pos,
            quats_xyzw=ref_quat,
            timeline_name=timeline_name,
            timeline_values=np.arange(ref_pos.shape[0], dtype=float),
        ...
        _send_timed_transforms(
            rr,
            entity_path="epa/replay/est/pose",
            positions=est_sel,
            quats_xyzw=est_quat,
            timeline_name=timeline_name,
            timeline_values=t,
        ...
        _send_scalar_series(
            rr,
            entity_path=f"epa/error/scalars/{metric_name}_{relation}",
            values=errs,
            timeline_name=timeline_name,
            timeline_values=t,
            color_rgba=[120, 155, 205, 255],
        ...
        _log_static_traj_label(
            rr,
            entity_path="epa/replay/ref/label",
            position_xyz=ref_pos[-1],
            text="ref",
        )
        _log_static_traj_label(
            rr,
            entity_path="epa/replay/est/label",
