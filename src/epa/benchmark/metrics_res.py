...
from epa.viz.metric_plots import aggregate_metric_results, generate_metric_plots
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Metric plotting and result aggregation for epa metrics.json files."
    )
    parser.add_argument(
        "--config",
        default="",
...
def main() -> int:
    parser = build_parser()
    args = parse_args_with_config(parser, config_dest="config", tool_name="epa_metric_res")
    return run(args)
