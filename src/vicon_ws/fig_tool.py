...
from vicon_ws.viz.plot_bundle import iter_figure_specs, load_plot_bundle, render_figure_spec


def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="Render serialized plot bundles (vicon_ws figure specs)."
    )
    p.add_argument(
        "bundles",
        nargs="+",
