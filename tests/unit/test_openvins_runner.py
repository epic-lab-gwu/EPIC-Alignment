...
def test_openvins_runner_maps_epa_modes_without_extra_se3_alignment() -> None:
    ...
    assert _map_align_mode_to_eval_align("se3r") == "se3"
    assert _map_align_mode_to_eval_align("se3-original") == "se3-original"
    assert _map_align_mode_to_eval_align("se3-orginal") == "se3-original"
